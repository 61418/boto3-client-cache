...
def test_resource_cache_key_moves_service_name_kwarg_into_args() -> None:
    positional = ResourceCacheKey("s3", region_name="us-east-1")
    keyword = ResourceCacheKey(service_name="s3", region_name="us-east-1")
...
def test_resource_cache_key_removes_session_cache_control_kwargs() -> None:
    plain = ResourceCacheKey("s3", region_name="us-east-1")
    with_controls = ResourceCacheKey(
        "s3",
        region_name="us-east-1",
        eviction_policy="LFU",
        max_size=123,
